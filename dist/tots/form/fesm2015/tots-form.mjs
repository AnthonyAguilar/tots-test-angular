...
class TotsBaseFieldComponent {
    ...
    static updateFormByItem(group, item, field) {
        var _a, _b;
        if (Array.isArray(field.key)) {
            (_a = group.get(field.key.join('_'))) === null || _a === void 0 ? void 0 : _a.setValue(TotsFormHelper.getItemValueByKey(item, field.key));
        }
        else {
            (_b = group.get(field.key)) === null || _b === void 0 ? void 0 : _b.setValue(item[field.key]);
        }
    }
    static updateItemByForm(group, item, field) {
        var _a, _b;
        if (Array.isArray(field.key)) {
            TotsFormHelper.setValueInItemByKey(item, field.key, (_a = group.get(field.key.join('_'))) === null || _a === void 0 ? void 0 : _a.value);
        }
        else {
            item[field.key] = (_b = group.get(field.key)) === null || _b === void 0 ? void 0 : _b.value;
        }
    }
}
...
class StringFieldComponent extends TotsBaseFieldComponent {
    ...
    get icon() {
        var _a;
        return (_a = this.field.extra) === null || _a === void 0 ? void 0 : _a.icon;
    }
}
...
class SubmitButtonFieldComponent extends TotsBaseFieldComponent {
    ...
    ngOnInit() {
        var _a, _b;
        this.matColor = ((_a = this.field.extra) === null || _a === void 0 ? void 0 : _a.matColor) || this.totsButtonConfig.positiveButtonColor;
        this.matButtonDirective = ((_b = this.field.extra) === null || _b === void 0 ? void 0 : _b.matButtonDirective) || this.totsButtonConfig.positiveButtonMaterialDirective;
    }
    onClick() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.3", ngImport: i0, type: SubmitButtonFieldComponent, decorators: [{
        ...
        return [{ type: TotsFormButtonsConfig, decorators: [{
                        type: Inject,
...
class SubmitAndCancelButtonsFieldComponent extends TotsBaseFieldComponent {
    ...
    ngOnInit() {
        var _a, _b, _c, _d;
        this.submitMatColor = ((_a = this.field.extra) === null || _a === void 0 ? void 0 : _a.matColor) || this.totsButtonConfig.positiveButtonColor;
        this.submitMatButtonDirective = ((_b = this.field.extra) === null || _b === void 0 ? void 0 : _b.matButtonDirective) || this.totsButtonConfig.positiveButtonMaterialDirective;
        this.cancelLabel = ((_c = this.field.extra) === null || _c === void 0 ? void 0 : _c.cancelLabel) || this.totsButtonConfig.negativeButtonCaption;
        this.cancelMatColor = this.totsButtonConfig.negativeButtonColor;
        this.cancelMatButtonDirective = ((_d = this.field.extra) === null || _d === void 0 ? void 0 : _d.matCancelButtonDirective) || this.totsButtonConfig.negativeButtonMaterialDirective;
    }
    onClick() {
        if (Array.isArray(this.field.key)) {
            this.onAction.next({ key: this.field.key.join('_'), item: {} });
...
class ToggleFieldComponent extends TotsBaseFieldComponent {
    ngOnInit() {
        var _a;
        super.ngOnInit();
        this.matColor = ((_a = this.field.extra) === null || _a === void 0 ? void 0 : _a.matColor) || "primary";
    }
}
...
class PasswordFieldComponent extends TotsBaseFieldComponent {
    ...
    getCaption() {
        var _a;
        return (_a = this.field.extra) === null || _a === void 0 ? void 0 : _a.caption;
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.3", ngImport: i0, type: TotsFormModalComponent, decorators: [{
        ...
        return [{ type: i1.MatDialogRef }, { type: TotsModalConfig, decorators: [{
                        type: Inject,
